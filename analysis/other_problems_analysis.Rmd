...
```{r, phen_vs_phylo, message=FALSE, cache=TRUE, warning=FALSE}
ggplot(
    final_data,
    aes(
        y=phenotype_num_taxa,
...
```{r, information_theory_mean_evolutionary_distinctivess, message=FALSE, cache=TRUE, warning=FALSE}
res <- data %>% group_by(SEED, selection_name, problem_name) %>%
summarise(
...
```{r, information_theory_variance_evolutionary_distinctivess, message=FALSE, cache=TRUE, warning=FALSE}
res <- data %>% group_by(SEED, selection_name, problem_name) %>%
summarise(
...
```{r, information_theory_pheno_phylo_evolutionary_distinctiveness, message=FALSE, cache=TRUE, warning=FALSE}
res <- data %>% group_by(SEED, selection_name, problem_name) %>%
summarise(
