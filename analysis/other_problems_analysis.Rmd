...
summarise(
  ...
  pheno_phylo_10000 =  condinformation(discretize(phenotype_num_taxa),
                                       discretize(lag(max_phenotype_pairwise_distance, 1000)),
                                       discretize(lag(phenotype_num_taxa, 1000))),
  pheno_phylo_100000 = condinformation(discretize(phenotype_num_taxa),
                                       discretize(lag(max_phenotype_pairwise_distance, 10000)),
                                       discretize(lag(phenotype_num_taxa, 10000))),
